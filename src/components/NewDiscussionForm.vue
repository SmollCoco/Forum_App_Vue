            ...
            <form class="d-flex flex-column justify-content-evenly h-100">
                ...
                <div>
                    ...
                    <div
                        v-else
                        id="title"
                        class="form-control rounded-pill p-4 my-3"
                    >
                        {{ post.titre }}
                        <span class="fs-6 text-danger d-block">
                ...
                <div v-else>
                    <div class="rounded border mb-4 p-4 fw-semibold fs-6">
                        <span class="text-primary mb-1 d-block">
                            Your previous content. To preserve integrity you are
                            only able to add text
                        </span>
                        <br />
                        {{ post.contenu }}
                    </div>
                ...
                <input
                    type="button"
                    class="btn rounded-pill fw-bold fx-w mt-3"
                    value="Submit"
                    :disabled="!post.titre"
